# ############################################################################
# **    Proyecto       : Metodo de trapecio multiple
# **    Plataforma     : VS Code
# **    Fecha/Hora     : 15/12/2025
# **    Descripción    : Practica desarrollada para corroborar el metodo de 
# **                     trapecio de aplicacion multiple para el calculo de 
